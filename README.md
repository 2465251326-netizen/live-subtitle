...
- **不重复上屏**：识别偶尔会把刚说过的一句连着尾巴再转一遍（滑窗重播）。v2.23.0 起面板与主窗共用同一把"跨行回声"判据：这种重播不再另起一行、也不再被送去第二次翻译，屏上同一句只留最早那一条。四条护栏保证它不吞真话——只跟已出译文的历史句比、比原句明显更长的（转得更完整的版本）一律上屏、短句复读不去重、开头相同但内容不同的下一句不去重
