...
> 最后更新：2026-09-12 v2.5.1 发布后（真实新闻离线实测：启动恢复面板显隐+清除 Tool 隐含拒绝焦点使悬停滚轮可用）
...
- **当前版本**：**v2.5.1**（已发布，含 Setup EXE + portable zip 双资产）
