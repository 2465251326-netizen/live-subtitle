...
> 最后更新：2026-09-11 v2.3.21 发布后（P28 连续流空白穿透：翻案'整窗保护'假手势；P29 悬浮条纠错入口）
...
- **当前版本**：**v2.3.21**（已发布，含 Setup EXE + portable zip 双资产）
...
- 集成测试：`tests/test_integration.py`（43 项，覆盖配置/缓存/重采样/悬浮条三模式/字幕卡生命周期/热键/设置字段/QSS 括号/向导/退出清理/声明式行表/SRT/呼吸与贴边等体验回归）
