...
> 最后更新：2026-09-11 v2.3.15 发布后（第十轮 P19：电平量纲错配三连修；悬浮字幕形态=整句实证）
...
- **当前版本**：**v2.3.15**（已发布，含 Setup EXE + portable zip 双资产）
