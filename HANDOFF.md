...
> 最后更新：2026-09-11 v2.3.11 发布后（第七轮实测：无声音指引窗口 15s→25s 去固定噪音）
...
- **当前版本**：**v2.3.11**（已发布，含 Setup EXE + portable zip 双资产）
