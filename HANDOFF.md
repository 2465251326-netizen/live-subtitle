...
> 最后更新：2026-09-16 v2.15.3（分割线"布局缝隙"路径修复：过滤器+面板兜底双通道，见 CHANGELOG；v2.15.0-2.15.2 分割拖拽三轮修复史见 CHANGELOG 与第十九节追记）
...
- **当前版本**：**v2.15.3**（已发布，含 Setup EXE + portable zip 双资产）
